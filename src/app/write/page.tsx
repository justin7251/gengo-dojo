        ...
        <div style={{ textAlign: 'center', padding: '2rem 0' }}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            <div className="progress-track" style={{ height: '8px', borderRadius: '4px' }}>
              <div className="progress-fill" style={{
                width: `${pctC}%`, height: '8px', borderRadius: '4px',
                background: pctC >= 80 ? 'var(--teal)' : pctC >= 50 ? '#EF9F27' : '#E24B4A',
              }} />
            </div>
          ...
          <div style={{ display: 'flex', gap: '8px', justifyContent: 'center' }}>
            <button className="btn btn-primary" onClick={() => {
              ...
              setStats({ correct: 0, wrong: 0 }); clearCanvas();
            }}>
              Practice again
            </button>
      ...
      {hasStrokes && (
        <div style={{ animation: 'fadeIn 0.2s ease' }}>
          <p style={{
            fontSize: '11px', textTransform: 'uppercase',
            letterSpacing: '0.08em', color: 'var(--muted)',
            fontWeight: 500, textAlign: 'center', marginBottom: '10px',
          }}>
            How did it look?
          </p>
