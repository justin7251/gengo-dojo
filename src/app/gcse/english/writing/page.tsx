...
function Spinner() { return <div style={{ width: '32px', height: '32px', border: '2px solid rgba(212,83,126,0.2)', borderTopColor: '#D4537E', borderRadius: '50%', animation: 'spin 0.7s linear infinite' }} />; }
